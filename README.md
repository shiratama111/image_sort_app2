...
1. **Botをサーバーに招待**
   - [公式サイト](https://ai-ebisuya.kei31.com/)からBotを招待
...
#### 1. リポジトリの準備
```bash
git clone https://github.com/tejastice/ai-ebisuya.git
cd ai-ebisuya
```
...
```bash
# macOS/Linux
python3 -m venv ai-ebisuya-env

# Windows
python -m venv ai-ebisuya-env
# または
py -m venv ai-ebisuya-env
```

**仮想環境の有効化:**
```bash
# macOS/Linux
source ai-ebisuya-env/bin/activate

# Windows
ai-ebisuya-env\Scripts\activate
```
...
├── ai-ebisuya.bat         # Windows起動スクリプト（英語版）
...
### Windows文字化け問題
現在の`ai-ebisuya.bat`は英語版で作成済みのため、文字化け問題は解消されています。
もし問題が発生した場合：
...
- [公式サイト](https://ai-ebisuya.kei31.com/)
- [サポートサーバー](https://discord.gg/7b5g3RbjYv)
- [プライバシーポリシー](https://ai-ebisuya.kei31.com/privacy.html)
...
**🚀 今すぐ試す**: [公式サイト](https://ai-ebisuya.kei31.com/)からBotを招待してDiscordサーバーで体験！